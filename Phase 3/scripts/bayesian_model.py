...
for i, match in df.iterrows():
    ...
    error_home = home_xg - match['home_xG']
    home_stats['attack_mean_home'] += learning_rate * error_home
    home_stats['defence_mean_home'] += learning_rate * (away_xg - match['away_xG'])
    ...
    error_away = away_xg - match['away_xG']
    away_stats['attack_mean_away'] += learning_rate * error_away
    away_stats['defence_mean_away'] += learning_rate * (home_xg - match['home_xG'])
