...
def run():
    print("Calculating rolling stats with weighted average...")
    import pandas as pd
    import numpy as np
    ...
    enriched_rows = []
    # calculate rolling stats with weighted averages
    for i, match in df.iterrows():
        ...
        if len(past_matches) == 0:
            ...
            # Calculate weighted averages for home team attack and defence
        ...
        if len(away_past_matches) == 0:
            ...
            # Calculate weighted averages for away team attack and defence
        ...
        # calculate mean and variance of goals scored in past matches for negative binomial parameter estimation
