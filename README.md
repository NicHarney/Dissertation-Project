...
The data for Phase 1 has been obtained from [football-data](https://www.football-data.co.uk/data.php).
The data for Phase 2 and 3 has been obtained from [understat](https://understat.com/).
